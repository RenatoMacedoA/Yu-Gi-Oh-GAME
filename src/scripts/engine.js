...
async function setCardsField(cardId){
    // Remove as cartas das mãos antes de mostrar o resultado
    ...
    let duelResults = await checkDuelResults(parseInt(cardId), computerCardId);
...
// Corrigido para limpar as cartas de ambos os lados no DOM
...
async function resetDuel() {
    // Limpa os detalhes da carta lateral
    state.cardSprites.avatar.src = "";
    state.cardSprites.name.innerText = "Selecione";
    state.cardSprites.type.innerText = "uma carta";
    
    // Esconde o botão e o campo
    state.actions.button.style.display = "none";
    await showHiddenCardFieldsImages(false);

    // Reinicia o sorteio das cartas
    init();
}
